...
@section('content')
  ...
  <div class="content-wrapper container-fluid">
    ...
    <div class="content-wrapper container p-3">
      @include('components.content_header', ['content' => 'Role edit'])
                ...
                @foreach ($permissionItem->permissionChildren as $item)
                  <div class="card-body col-md-3">
                    <div class="d-flex align-center">
                      ...
                      <input type="checkbox" class="form-control permission_bottom" value="{{ $item->id }}" name="permission_id[]" {{ $permissionChecked->contains('id', $item->id) ? 'checked' : '' }}>
                    </div>
                  </div>
                @endforeach
            </div>
